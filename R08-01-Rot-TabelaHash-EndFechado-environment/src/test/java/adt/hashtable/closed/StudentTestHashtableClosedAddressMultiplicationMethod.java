...
public class StudentTestHashtableClosedAddressMultiplicationMethod {
	...
	public void testInsert() {
		...
		assertEquals(new Integer(105), table1.search(105));
		table1.insert(110); // nao produz colisao
		assertEquals(13, table1.getCOLLISIONS());
		assertEquals(98, table1.indexOf(110));
		assertEquals(new Integer(110), table1.search(110));
		table1.insert(101); //
		assertEquals(13, table1.getCOLLISIONS());
		...
		assertEquals(new Integer(102), table1.search(102));
		...
		assertEquals(new Integer(103), table2.search(103));
	}
	...
	public void testRemove() {
		...
		table1.remove(100); //elemento inexistente, tamanho nao se altera
		assertEquals(currentSize - 1, table1.size());
		assertEquals(-1, table1.indexOf(200));
	}
